...
const phases: Phase[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "c2", title: "About page", done: true },
      { id: "c3", title: "Contact form", detail: "Messages stored in DB, no PII emailed", done: true },
      { id: "c4", title: "Job-seeker info + employer info pages" },
      { id: "c5", title: "Terms + privacy (copy from current site, review)" },
      { id: "c7", title: "Signup chooser, pricing, why-us, candidate directory", detail: "/register, /pricing (first listing free), /why-us comparison, /search-candidates — every nav and footer link now resolves", done: true },
